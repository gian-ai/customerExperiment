...
if not st.session_state.logged_in:
    ...
    # Target audience and industry input and save
    ...
    # Pain points and features input and save
    ...
    # Platform, language, and message sequence setup
    ...
    # If campaign is generated, generate the phase content
